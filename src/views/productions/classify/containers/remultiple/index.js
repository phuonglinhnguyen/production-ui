...
import ClassifyImage from "../../components/re_multiple/classify_image_component";
import ClassifyData from "../../components/re_multiple/classify_data_component";
...
import {
  ...
  saveTask,
  getTask
} from "../../actions/reclassify_multiple_action";
import {
  setTextSearch,
...
const mapStateToProps = state => {
  const { layout_definitions, classify_multiple } = state.production.classify;
  const { user } = state;

  return {
    data_classify: classify_multiple,
    layout_definitions,

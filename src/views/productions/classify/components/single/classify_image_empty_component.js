...
class ClassifyImageEmpty extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div style={styles.main}>
        ...
        {!is_multiple && (
          <GridList style={styles.gridList} cellHeight={30} cols={2}>
            ...
            <GridTile style={styles.label_decription}>
              <Translate value={"productions.classify.select_layout"} />
            </GridTile>
            <GridTile style={styles.label_shortcut}>
              <Translate value={"productions.classify.number_keys"} />
            </GridTile>
          </GridList>
        )}
        {is_multiple && (
          <GridList style={styles.gridList} cellHeight={30} cols={2}>
            ...
            <GridTile style={styles.label_decription}>
              <Translate value={"productions.classify.view_original_image"} />
            </GridTile> 
            <GridTile style={styles.label_shortcut}>
              <Translate value={"productions.classify.enter_key"} />
            </GridTile>
            <GridTile style={styles.label_decription}>
              <Translate value={"productions.classify.go_next_back_up_down"} />
            </GridTile>
            <GridTile>
...
export default ClassifyImageEmpty;
